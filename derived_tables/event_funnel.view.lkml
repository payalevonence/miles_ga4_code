...
## Dimensions
  dimension: event_1 {
    type: string
    hidden: yes
    sql: case when ${events_dt.event_rank_asc} = 1 then ${event_name} end;;
  }
  dimension: event_2 {
    type: string
    hidden: yes
    sql: case when ${events_dt.event_rank_asc} = 2 then ${event_name} end;;
  }
  dimension: event_3 {
    type: string
    hidden: yes
    sql: case when ${events_dt.event_rank_asc} = 3 then ${event_name} end;;
  }
  dimension: event_4 {
    type: string
    hidden: yes
    sql: case when ${events_dt.event_rank_asc} = 4 then ${event_name} end;;
  }
  dimension: event_5 {
    type: string
    hidden: yes
    sql: case when ${events_dt.event_rank_asc} = 5 then ${event_name} end;;
  }
  dimension: event_6 {
    type: string
    hidden: yes
    sql: case when ${events_dt.event_rank_asc} = 6 then ${event_name} end;;
  }

...
## Filters
  ...
  dimension: page_1 {
    type: string
    hidden: yes
    sql: case when ${page_views.page_view_rank_asc} = 1 then ${page} end;;
  }
  dimension: page_2 {
    type: string
    hidden: yes
    sql: case when ${page_views.page_view_rank_asc} = 2 then ${page} end;;
  }
  dimension: page_3 {
    type: string
    hidden: yes
    sql: case when ${page_views.page_view_rank_asc} = 3 then ${page} end;;
  }
  dimension: page_4 {
    type: string
    hidden: yes
    sql: case when ${page_views.page_view_rank_asc} = 4 then ${page} end;;
  }
  dimension: page_5 {
    type: string
    hidden: yes
    sql: case when ${page_views.page_view_rank_asc} = 5 then ${page} end;;
  }
  dimension: page_6 {
    type: string
    hidden: yes
    sql: case when ${page_views.page_view_rank_asc} = 6 then ${page} end;;
  }
